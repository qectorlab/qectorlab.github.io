            ...
            <div ref={(el) => addRef(el, 5)} className="card-surface">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { year: '2026 Q2', event: 'QECTOR Workbench v0.5.2 release. CustomTkinter GUI, 56-tool MCP server, 16 decoders, and 10 code families, shipped fully self-contained for Windows x64 and Linux x64 — no system Python, pip, or internet connection required.' },
                ].map((item) => (
