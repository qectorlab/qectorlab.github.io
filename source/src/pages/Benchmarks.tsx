      ...
      <section className="section-padding pb-24">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div ref={(el) => addRef(el, 6)} className="card-surface">
            <h3 className="text-cyan-300 font-semibold mb-4">Performance Characteristics (v0.7.0)</h3>
          ...
          <div ref={(el) => addRef(el, 8)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card-surface">
              ...
              <p className="text-secondary text-sm leading-relaxed mb-4">
                Every decoder in the v0.7.0 benchmark suite reproduces the parity-check equation
