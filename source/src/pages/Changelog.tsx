          ...
          <div className="relative">
            ...
            <ChangelogEntry
              ...
              items={[
                ...
                'Free QECTOR Workbench (current): Comprehensive MCP tools, 17 decoder backends, 10 code families, including qLDPC and colour codes, visual circuit builder, and a self/auto-debug layer verifying H·c = s on every decode',
