  ...
  return (
    <>
      <SEO
        ...
        description="SATI OS technology is integrated into QECTOR Workbench v3.5.1 and QECTOR Decoder v3. Explore the free desktop app and decoder library."
      />
      ...
      <section className="relative py-28 md:py-40 text-center overflow-hidden min-h-[75vh] flex items-center justify-center">
        ...
        <div className="relative z-10 section-padding max-w-4xl mx-auto">
          ...
          <p className="text-secondary text-xl md:text-2xl font-light max-w-2xl mx-auto leading-relaxed mb-6 text-cyan-100">
            SATI OS features are fully integrated into QECTOR Workbench v3.5.1 and QECTOR Decoder v3.
          </p>

          <p className="text-muted-foreground text-sm md:text-base max-w-xl mx-auto leading-relaxed mb-10">
            The full-stack GUI, 47 MCP tools, FastAPI REST engine, dual CLI, and decoder suite are available directly in the free QECTOR Workbench desktop application.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              Explore QECTOR Workbench v3.5.1
