      ...
      <section className="relative py-24 md:py-32 text-center overflow-hidden">
        ...
        <div className="relative z-10 section-padding">
          ...
          <p className="text-secondary text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-8">
            ...
            The core decoder is Source-Available (not free); the Workbench GUI app is free. Full SATI OS adds commercial HAL adapters, expanded MCP, support, and enterprise features.
          </p>
          ...
          <div ref={(el) => addRef(el, 1)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { layer: 'Engine Layer', items: [`New QECTOR Decoder v3 (Source-Available, not free, v${pypiVersion})`, 'New free QectorWorkbench GUI v3.4', 'Headless + Stim/PyMatching'] },
